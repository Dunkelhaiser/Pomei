...
const editorVariants = cva(
    cn(
        "relative overflow-x-auto whitespace-pre-wrap break-words transition",
    ...
    ),
    {
        variants: {
            ...
            focused: {
                true: "ring-2 ring-accent-foreground ring-offset-0",
            },
            disabled: {
                true: "cursor-not-allowed opacity-50",
            },
            focusRing: {
                true: "focus-visible:ring-2 focus-visible:ring-accent-foreground focus-visible:ring-offset-0",
                false: "",
            },
            size: {
                sm: "text-sm",
